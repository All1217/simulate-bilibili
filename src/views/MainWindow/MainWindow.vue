      ...
      <div class="partition">
        ...
        <div class="right-channel-container">
          <div class="channel-items-left">
            <a v-for="e, index in partitonList" v-show="index <= 20">
              {{ e.name }}
            </a>
            <a href="">更多&nbsp;<i class="iconfont icon-arrow"></i></a>
          </div>
          <div class="channel-items-right">
            <a v-for="item in partition_right" :key="item.id" href="">
            ...
            <div class="video-card">
              <div class="img" @click="onVideoClick(e)">
                ...
                <div class="video-info">
                  ...
                  <span>{{ formatVideoDuration(e.duration) }}</span>
                </div>
              </div>
...
import { formatVideoDuration, formatCount, sliceDateTime } from '@/util/index'

...
const routes: RouteRecordRaw[] = [
  ...
  },
  {
    ...
    children: [
      { path: 'whisper', component: () => import('@/components/MessageCenter/Whisper.vue') },
      { path: 'system', component: () => import('@/components/MessageCenter/System.vue') },
    ]
  },
  {
    path: '/user_page/:uid',
    ...
    children: [
      ...
      { path: 'fanslist', component: () => import('@/components/UserPage/FansList.vue') },
    ]
  },
  {
    path: '/video/:vid',
